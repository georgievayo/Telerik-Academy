...
public class Student
{
    ...
    public IList<ExamResult> CheckExams()
    {
        if (this.Exams == null)
        {
            throw new ArgumentNullException("Exams are not initialized!");
        }

        if (this.Exams.Count == 0)
        {
            throw new ArgumentOutOfRangeException("The student should have almost one exam!");
        }
    ...
    public double CalcAverageExamResultInPercents()
    {
        ...
        if (this.Exams.Count == 0)
        {
            throw new ArgumentOutOfRangeException("Cannot calculate average of 0 exams!");
        }
